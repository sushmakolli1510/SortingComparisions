...
//initialize left and right subarray
    ...
    //In-Place quick sort
    static void inPlaceQuickSort( int leftelement, int rightelement
            ,int inputArray[]) {
    ...
    //Modified Qicksort using median
    ...
    public static void modifiedQuickSort(int[] inputarr, int leftelement, int rightelement) {
        if(leftelement + 10 <= rightelement) {
            //using median elemnet as pivot
